...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "teaching",
          description: "Info on courses and webinars",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-4-per-1000",
          title: '4 per 1000',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%62%72%75%6E%69@%67%65%6F%6C%6F%67%69%65.%65%6E%73.%66%72", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/elisabruni", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/elisa-bruni-01366197", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=2Obug38AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
